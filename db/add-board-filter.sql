-- ============================================================================
-- add-board-filter.sql — מוסיף "by_board" ל-ai_overview_summary כדי לאפשר
-- לסנן את דשבורד "סקירת AI" לבורד בודד ולראות את החיסכון ברמה הפרטנית שלו
-- (במקום רק סה"כ חוצה-צוותים). בטוח להריץ שוב — create or replace בלבד.
-- ============================================================================
