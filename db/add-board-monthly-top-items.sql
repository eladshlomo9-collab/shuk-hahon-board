-- ============================================================================
-- add-board-monthly-top-items.sql — מוסיף top_items (עד 3 המשימות עם החיסכון
-- הגדול ביותר) לכל חודש בתוך by_board[].monthly_trend, כדי לאפשר להסביר
-- שינויים חדים בהתייעלות חודשית ("למה יולי היה גבוה מאוגוסט") בלי לצאת
-- מהדשבורד. מוצג רק בתצוגת בורד מסונן (by_board) — לא בתצוגה הארגונית
-- הכללית (monthly_trend הראשי) כדי לא לחשוף שמות משימות חוצי-צוותים שם.
...
begin
  ...
  -- דירוג משימות בתוך כל בורד+חודש, כדי לשלוף את 3 המשימות עם החיסכון הגדול
  -- ביותר (משמש רק ב-by_board — לא בתצוגה הארגונית הכללית).
